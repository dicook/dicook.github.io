...
![rogers](rogers_files/figure-html/rogers-howstat.png)
...
![](rogers_files/figure-html/unnamed-chunk-2-1.png)\ 
...
![](rogers_files/figure-html/unnamed-chunk-3-1.png)\ 
...
![](rogers_files/figure-html/unnamed-chunk-4-1.png)\ 
...
![](rogers_files/figure-html/unnamed-chunk-5-1.png)\ 
...
![](rogers_files/figure-html/unnamed-chunk-6-1.png)\ 
...
![](rogers_files/figure-html/unnamed-chunk-7-1.png)\ 
...
![](rogers_files/figure-html/unnamed-chunk-8-1.png)\ 
...
![](rogers_files/figure-html/unnamed-chunk-9-1.png)\ 
...
![](rogers_files/figure-html/unnamed-chunk-10-1.png)\ 
...
![](rogers_files/figure-html/unnamed-chunk-11-1.png)\ ![](rogers_files/figure-html/unnamed-chunk-11-2.png)\ 
...
I recommend showing dotplots of the runs by season, instead of bar charts by index. Ideally overlaying summary statistics such as averages and standard deviations to simplify comparison across seasons. 


```r
seasonstats <- rogers2 %>% group_by(Season) %>% summarise(m=mean(Runs, na.rm=T), s=sd(Runs, na.rm=T))
ggplot(data=rogers2) + 
  geom_hline(yintercept=100, colour="grey90") + 
  geom_hline(yintercept=50, colour="grey90") + 
  geom_hline(yintercept=0, colour="grey90") + 
  geom_point(aes(x=Season, y=Runs), size=5, alpha=0.5, 
      position = position_jitter(width = .1)) +
  geom_errorbar(data=seasonstats, aes(x=Season, ymin=m-s, ymax=m+s), 
                width=0.1, color="blue", size=2) +
  theme_bw()
```

![](rogers_files/figure-html/unnamed-chunk-12-1.png)\ 
...
Plots were made using these R packages: ggplot2, tidyr, dplyr, readr, lubridate.
